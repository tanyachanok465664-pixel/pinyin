 ...
 * ============================================================ */
  ...
  function resetPracticeModal() {
    ...
    document.getElementById('listen-phoneme-btn').textContent = '▶ ฟังเสียงหน่วยเสียง';
    document.getElementById('listen-phoneme-btn').disabled = false;
  ...
  function playPhonemeAudio() {
    speakText(PhoneticState.currentItem.pinyin, document.getElementById('listen-phoneme-btn'));
  }
